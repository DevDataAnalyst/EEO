...
$(document).ready(function () {
    ...
    $(".submit").click(function () {
        ...
        if ($(this).hasClass("active")) {
            if ($(".option1").hasClass("clicked") && $(".option2").hasClass("clicked") && $(".option3").hasClass("clicked") && $(".option4").hasClass("clicked") && ($(".lowerLayoutContainer .clicked").length == 12) && counter <= 1) {
                //$(".popUp1").show();
                feedBack = true;
                score++;
                goNext();

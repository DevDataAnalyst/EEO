...
$(document).ready(function () {
    ...
    $(".tab").click(function () {
		...
		if($(this).hasClass("tab1")){
		 $("#para3").focus();
            $(".tab1").prop("src","img/tab_page/slide_31/slide_31_tab_1_n.png");
            $(".tab2").prop("src","img/tab_page/slide_31/slide_31_tab_2_d.png")
        }
        else if ($(this).hasClass("tab2")){
		    $("#para5").focus();
            $(".tab1").prop("src","img/tab_page/slide_31/slide_31_tab_1_d.png");
            $(".tab2").prop("src","img/tab_page/slide_31/slide_31_tab_2_n.png")
        }
        if($(this).hasClass("tab1")){
